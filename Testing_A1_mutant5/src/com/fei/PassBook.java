...
public class PassBook 
{
	...
	public static int getMinimumPassphraseLength() {
		return MINIMUM_PASSPHRASE_LENGTH;
	}

	public static String[] getValidUrlProtocols() {
		return VALID_URL_PROTOCOLS;
	}
	...
	//check the passphrase strength
		...
		else if ('A' < passphrase.charAt(i) && passphrase.charAt(i) <= 'Z') {			//here！！！
